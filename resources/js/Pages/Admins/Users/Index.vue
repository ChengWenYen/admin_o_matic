                                        ...
                                        <tbody>
                                            <tr v-for="(user, index) in users.data" :key="index">
                                                ...
                                                <td class="text-right" v-if="$page.props.auth.hasRole.superAdmin || $page.props.auth.hasRole.admin">
                                                    <button class="btn btn-success text-uppercase" style="letter-spacing: 0.1em;" @click="editModal(user)">
                                                        Edit
                                                    </button>
                                                    <button class="btn btn-danger text-uppercase ml-1" style="letter-spacing: 0.1em;" @click="deleteUser(user)">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-hidden">
                            <div class="d-flex flex-column h4">
                                ...
                                <span class="mt-3">Preview e-mail: <span>{{ form.email }}</span></span> 
                            </div>
                                ...
                                <form @submit.prevent="checkMode">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" placeholder="Name" v-model="form.name" :class="{'is-invalid': form.errors.name}" autofocus="autofocus" autocomplete="off">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" placeholder="E-mail Address" v-model="form.email" :class="{'is-invalid': form.errors.email}" autofocus="autofocus" autocomplete="off">
                                        </div>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <button type="submit" class="btn btn-info text-uppercase" style="letter-spacing: 0.1em;" :disabled="!form.name || !form.email || form.processing">{{ buttonText }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
