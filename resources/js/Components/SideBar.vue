<template>
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <inertia-link :href="route('admin.dashboard.index')" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Admin-O-Mateic</span>
    </inertia-link>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item" v-if="$page.props.auth.hasRole.superAdmin || $page.props.auth.hasRole.admin">
                <inertia-link :href="route('admin.permissions.index')" class="nav-link" :class="route().current('admin.permission.*') ? 'active' : ''">
                    <i class="fas fa-circle nav-icon"></i>
                    <p>Permissions</p>
                </inertia-link>
              </li>
